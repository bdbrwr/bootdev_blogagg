...
SELECT
     insterted_feed_follow.id, insterted_feed_follow.created_at, insterted_feed_follow.updated_at, insterted_feed_follow.user_id, insterted_feed_follow.feed_id
